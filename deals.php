...
<section class="parallax-window" data-parallax="scroll" data-image-src="img/deals.jpg" data-natural-width="1400" data-natural-height="470">
...
<div  class="container margin_60">
            ...
            <div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.1s">
               <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2">
                    <div class="price_list"><div><sup>R</sup>899<span class="normal_price_list">R999</span><small>Per night</small>
    ...
    <aside class="col-md-3">
            <div class="widget" id="cat_blog">
                <h4>Categories</h4>
                <ul>
                    <li><a href="#">D&eacute;cor, floral and hiring</a></li>
                    <li><a href="#">Food and Beverage</a></li>
                    <li><a href="#">Music and Entertainment</a></li>
                    <li><a href="#">AV & Technical</a></li>
                    <li><a href="#">Transport and Logistics</a></li>
                    <li><a href="#">Venues, Temporary and inflatable Structures</a></li>
                    <li><a href="#">Event Management and Staffing</a></li>
