        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-3 col-xs-3">
                    <div id="logo">
                        <a href="index.html"><img src="img/logo_sticky.png" width="140" height="67" alt="EVENTIT" data-retina="true" class="logo_normal"></a>
                        <a href="index.html"><img src="img/logo_sticky.png" width="140" height="67" alt="EVENTIT" data-retina="true" class="logo_sticky"></a>
                    </div>
                </div>
...
<div  class="container margin_60">
        ...
        <div class="col-lg-9 col-md-9">
            	...
            	<a class="tooltip_flip tooltip-effect-1" href="javascript:void(0);">+<span class="tooltip-content-flip"><span class="tooltip-back">Add to wishlist</span></span></a>
                    	...
                    	<div class="img_list"><a href="single_hotel.html"><div class="popular" ></div><img src="img/hotel_1.jpg" alt="">
            	...
            	<a class="tooltip_flip tooltip-effect-1" href="javascript:void(0);">+<span class="tooltip-content-flip"><span class="tooltip-back">Add to wishlist</span></span></a>
                    	...
                    	<div class="img_list"><a href="single_hotel.html"><div class="top_rated" ></div><img src="img/hotel_2.jpg" alt="">
                        <div class="short_info"></div>
                        </a>
                        </div>
                    </div>
            	...
            	<a class="tooltip_flip tooltip-effect-1" href="javascript:void(0);">+<span class="tooltip-content-flip"><span class="tooltip-back">Add to wishlist</span></span></a>
                    	...
                    	<div class="img_list"><a href="single_hotel.html"><div class="top_rated" ></div><img src="img/hotel_3.jpg" alt="">
                        <div class="short_info"></div>
                        </a>
                        </div>
                    </div>
            	...
            	<a class="tooltip_flip tooltip-effect-1" href="javascript:void(0);">+<span class="tooltip-content-flip"><span class="tooltip-back">Add to wishlist</span></span></a>
                    	...
                    	<div class="img_list"><a href="single_hotel.html"><div class="top_rated" ></div><img src="img/hotel_4.jpg" alt="">
                        <div class="short_info"></div>
                        </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                    		<div class="tour_list_desc">
                            <div id="score">Good<span>7.5</span></div>
            	...
            	<a class="tooltip_flip tooltip-effect-1" href="javascript:void(0);">+<span class="tooltip-content-flip"><span class="tooltip-back">Add to wishlist</span></span></a>
                    	...
                    	<div class="img_list"><a href="single_hotel.html"><div class="top_rated" ></div><img src="img/hotel_5.jpg" alt="">
                        <div class="short_info"></div>
                        </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                    		<div class="tour_list_desc">
                            <div id="score">Very Good<span>8.0</span></div>
                            <div class="rating"><i class="icon-star voted"></i><i class="icon-star  voted"></i><i class="icon-star  voted"></i><i class="icon-star  voted"></i><i class="icon-star  voted"></i></div>
                            <h3><strong>Concorde</strong> Hotel</h3>
                            <p>Lorem ipsum dolor sit amet, quem convenire interesset ut vix, ad dicat sanctus detracto vis. Eos modus dolorum...</p>
                            <ul class="add_info">
