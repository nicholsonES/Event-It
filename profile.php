                    ...
                    <div class="row">
                        <div class="col-md-8" id="single_tour_desc">
                            <div>
                                <div class="col-md-12">
                                    <h4>Tentation</h4>
                                    <p>
                                        Tentation Bedouin and Stretch Tent Hire was founded in Cape Town but has is now offering its services to the Johannesburg events industry.
                                    </p>
                                    <p>Our beautiful, top of the range Stretch tents have become the preferred option of tent hire for weddings, corporate events and private functions in the Western Cape and Gauteng, we are now available to you too!</p>
                                    <p>Tentation has established itself as a reliable and passionate events company, with service and professionalism our top priority.</p>
                                    <h4>Products and services</h4>
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <ul class="list_ok">
                                                <li>When hiring a stretch tent with Tentation, you get much more than just an ordinary tent</li>
                                                <li>Our stretch tents for hire are radical innovations in the global tenting and marquee industry.</li>
                                                <li>The unique 100% waterproof stretch fabric ensures their capacity for transformation and re-invention of space is spectacular. Our larger stretch tents for hire comes with options including: sides can be placed up or down, poles re-positioned to accommodate numbers and create different shapes.</li>
                                                <li>Stretch Tents are highly useful as they can be wrapped around tress, rocks and walls and can be erected with or without poles, sieze dependent.</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <!-- End row  -->
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p>
                                        When you hire a marquee or tent with Tentation, you get much more than just a tent. You will receive an events company full of passion and fully committed to making your Cape Town or Johannesburg event a success.
                                    </p>
                                </div>
                                <!-- End col-md-9  -->
                            </div>
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="box_style_1">
                                ...
                                <h4>Johannesburg <span><i class="icon-address pull-right"></i></span></h4>
                                <p>
                                    77 Simmonds Street<br/>
                                    Johannesburg<br/>
                                    0000<br/>
                                </p>
                                <hr>
                            ...
                            <div class="box_style_1">
                                ...
                                <div class="form_title">
                                    <h3><strong><i class="icon-pencil"></i></strong>Contact US</h3>
                                    <p>
                                        Please fill in the form below and well get back to you ASAP :)
                                    </p>
                                </div>
